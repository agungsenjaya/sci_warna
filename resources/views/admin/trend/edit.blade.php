...
<div>
	...
	<div>
	<h4 class="mb-0 title-2">Update Tren</h4>
    <p>Halaman edit tren warna</p>
	</div>
	<div>
...
@endif
	<form action="{{ route('update.trend',['id' => $data->id ]) }}" method="POST" enctype="multipart/form-data">
            {{ CSRF_FIELD() }}
            <div class="form-group">
              <div class="">
                <label for="">Judul Tren</label>
                <input required="" type="text" class="form-control" placeholder="Judul Tren" name="judul" value="{{ $data->judul }}">
              </div>
            </div>
            <div class="form-row">
              <div class="col">
              ...
              <div class="col">
                ...
                <input type="text" name="year" class="form-control" placeholder="Masukan tahun" value="{{ $data->year }}">
              </div>
            </div>
			<div class="form-group mt-3">
				<label for="">Konten Tren</label>
				<textarea id="ane" class="form-control" cols="30" rows="10" name="konten">
        {{ $data->konten }}
        </textarea>
			</div>
            <div class="mt-5">
